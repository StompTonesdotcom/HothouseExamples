...
| FOOTSWITCH 1 | Toggles "100% Wet" mode | Defeats the dry signal leaving only the wet signal; also disables the Reverb Send control and sets the send level to 100%.<br/>Useful in certain situations, (E.g., stereo or wet/dry set-ups).<br/>Hold *both* footswitches for 2 s to enter DFU (flashable) mode. |
